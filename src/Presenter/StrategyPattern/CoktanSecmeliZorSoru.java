...
public class CoktanSecmeliZorSoru implements SoruBankasiStrategy{
    ...
    {
         String path2 = "Content\\SoruBankasi\\TasarimDesenleriÇoktanSeçmeliZor.txt";
        
       
        
        if(zorlukDereceseiSelectedItem.equals("Zor")&&soruTipiSelectedItem.equals("Çoktan Seçmeli"))  {      
            try{
