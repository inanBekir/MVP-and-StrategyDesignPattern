...
public class ListeleZorSoru implements ListeleStrategy{
   ...
   private SoruBankasiView view;
    ...
    public void Listele(String text) {
        ...
        String path3 = "Content\\SoruBankasi\\TasarimDesenleriÇoktanSeçmeliZor.txt";
        String path2 = "Content\\SoruBankasi\\TasarimDesenleriKlasikZor.txt";
        String path = "Content\\SoruBankasi\\TasarimDesenleriDogruYanlisZor.txt";
