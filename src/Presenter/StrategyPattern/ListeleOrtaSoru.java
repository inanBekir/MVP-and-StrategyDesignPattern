...
public class ListeleOrtaSoru implements ListeleStrategy{
   ...
   private SoruBankasiView view;
    ...
    public void Listele(String text) {
        ...
        String path3 = "Content\\SoruBankasi\\TasarimDesenleriÇoktanSeçmeliOrta.txt";
        String path2 = "Content\\SoruBankasi\\TasarimDesenleriKlasikOrta.txt";
        String path = "Content\\SoruBankasi\\TasarimDesenleriDogruYanlisOrta.txt";
