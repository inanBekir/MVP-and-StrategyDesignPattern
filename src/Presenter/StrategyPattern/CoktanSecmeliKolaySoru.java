...
public class CoktanSecmeliKolaySoru implements SoruBankasiStrategy{
    ...
    {
        String path2 = "Content\\SoruBankasi\\TasarimDesenleriÇoktanSeçmeliKolay.txt";
        
       
        
        if(zorlukDereceseiSelectedItem.equals("Kolay")&&soruTipiSelectedItem.equals("Çoktan Seçmeli"))  {      
            try{
